...
export const VERSIONS = {
  ...
  export function vision(options: vision_v1p1beta1.Options): vision_v1p1beta1.Vision;
    export function vision(version: 'v1p2beta1'): vision_v1p2beta1.Vision;
  export function vision(options: vision_v1p2beta1.Options): vision_v1p2beta1.Vision;
export function vision<T = vision_v1.Vision|vision_v1p1beta1.Vision|vision_v1p2beta1.Vision>(this: GoogleConfigurable, versionOrOptions: 'v1'|vision_v1.Options|'v1p1beta1'|vision_v1p1beta1.Options|'v1p2beta1'|vision_v1p2beta1.Options) {
