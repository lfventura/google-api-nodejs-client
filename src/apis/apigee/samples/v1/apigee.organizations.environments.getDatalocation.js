...
async function main() {
  ...
  // Do the magic
  const res = await apigee.organizations.environments.getDatalocation({
    ...
    name: 'organizations/[^/]+/environments/[^/]+/datalocation',
    // Required. Relative path to the GCS bucket
    relativeFilePath: 'placeholder-value',
    // Required. Repository name
    repo: 'placeholder-value',
  });
